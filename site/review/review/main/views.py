...
def index(request):
    ...
    if request.method == 'POST':
        ...
        with open('\\NLP\\model_1.json', 'r') as f:
            model_1 = model_from_json(f.read())

        with open('\\NLP\\model_21.json', 'r') as f:
            model_21 = model_from_json(f.read())

        with open('\\NLP\\model_22.json', 'r') as f:
            model_22 = model_from_json(f.read())

        with open('\\NLP\\model_31.json', 'r') as f:
            model_31 = model_from_json(f.read())

        with open('\\NLP\\model_32.json', 'r') as f:
            model_32 = model_from_json(f.read())

        with open('\\NLP\\model_33.json', 'r') as f:
            model_33 = model_from_json(f.read())

        with open('\\NLP\\model_34.json', 'r') as f:
            model_34 = model_from_json(f.read())


        model_1.load_weights('\\NLP\\best_model_1.h5')
        model_21.load_weights('\\NLP\\best_model_21.h5')
        model_22.load_weights('\\NLP\\best_model_22.h5')
        model_31.load_weights('\\NLP\\best_model_31.h5')
        model_32.load_weights('\\NLP\\best_model_32.h5')
        model_33.load_weights('\\NLP\\best_model_33.h5')
        model_34.load_weights('\\NLP\\best_model_34.h5')
